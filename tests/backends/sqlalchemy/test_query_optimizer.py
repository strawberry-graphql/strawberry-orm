...
class TestQueryOptimizerEagerLoading:
    def test_optimizer_prevents_n_plus_1_for_posts(self, orm, sa_session, seed, query_counter, Post, User):
        @orm.type(Post)
        class PT:
            id: auto
            title: auto
    ...
    def test_optimizer_handles_nested_relationships(self, orm, sa_session, seed, query_counter, Post, Tag, User):
        @orm.type(Tag)
        class TT:
            id: auto
            name: auto
    ...
    def test_no_queries_for_scalar_only(self, orm, sa_session, seed, query_counter, User):
        @orm.type(User)
        class UT:
            id: auto
            name: auto
    ...
    def test_disable_optimization_blocks_load_extras(self, orm, sa_session, seed, query_counter, Post, Tag, User):
        @orm.type(Tag)
        class TT:
            id: auto
            name: auto
