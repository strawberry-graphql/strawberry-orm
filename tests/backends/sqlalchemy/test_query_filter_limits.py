...
class TestQueryFilterLimits:
    ...
    def test_filter_depth_limit_errors(self, sa_session, seed, User):
    ...
    def test_filter_branch_limit_errors(self, sa_session, seed, User):
    ...
    def test_filter_in_list_limit_errors(self, sa_session, seed, User):
    ...
    def test_regex_filter_works_when_enabled(self, sa_session, seed, User):
