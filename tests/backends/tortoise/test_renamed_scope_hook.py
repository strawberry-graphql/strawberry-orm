...
from tests.backends.tortoise.models import Post as SAPost


def _orm(**kwargs):
    return StrawberryORM.for_tortoise(lazy_resolution="off", **kwargs)
...
class TestRenamedScopeHook:
    ...
    async def test_the_new_name_still_works(self):
