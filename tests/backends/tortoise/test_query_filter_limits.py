...
class TestQueryFilterLimits:
    ...
    @pytest.mark.asyncio
    async def test_filter_depth_limit_errors(self, seed, User):
    ...
    @pytest.mark.asyncio
    async def test_filter_branch_limit_errors(self, seed, User):
    ...
    @pytest.mark.asyncio
    async def test_filter_in_list_limit_errors(self, seed, User):
    ...
    @pytest.mark.asyncio
    async def test_regex_filter_works_when_enabled(self, seed, User):
        ...
        assert result.errors is not None
        assert "Unknown filter param 'name__regex'" in str(result.errors[0])
